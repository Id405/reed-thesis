...
#show: thesis.with(
  ...
  acknowledgements: [
    ...
    All those from Reed College's fire spinning club Weapons of Mass Distraction -- Thank you for welcoming me in, and making me feel at home when I felt so far from home.
  ],
  dedication: [
